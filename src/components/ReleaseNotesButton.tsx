  ...
  return (
    <>
      ...
      {open && typeof document !== "undefined"
        ? createPortal(
            <div
              className="fixed inset-0 z-[70] bg-black/45 px-4 py-6 backdrop-blur-sm sm:px-6 sm:py-8"
              ...
              >
                <div className="flex items-start justify-between gap-4 border-b border-[var(--border)] px-5 py-4">
                  <div>
                    ...
                    {currentRelease ? <p className="mt-1 text-sm text-[var(--muted)]">{currentRelease.title}</p> : null}
                  </div>
